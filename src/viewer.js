...
function getCredential(formValues, callback, err) {
    if (err)
        ...
        var poolData = {
            UserPoolId: 'us-east-1_wLSgnWOiq', // Your user pool id here
            ClientId: '5t2qpunjm86tipu0so4apns4qa', // Your client id here
        };
        ...
        cognitoUser.authenticateUser(authenticationDetails, {
            onSuccess: function(result) {
                ...
                AWS.config.credentials = new AWS.CognitoIdentityCredentials({
                    IdentityPoolId: 'us-east-1:2283fa24-73a8-46d8-92d7-80e26badd84c', // your identity pool id here
                    Logins: {
                        // Change the key below according to the specific region your user pool is in.
                        'cognito-idp.us-east-1.amazonaws.com/us-east-1_wLSgnWOiq': result
                            .getIdToken()
                            .getJwtToken(),
                    },
                });
